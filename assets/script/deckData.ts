...
export default class deckData{
    ...
    // {cardType:cardType.CLOSE_ATK,cardName:'剑挡',isOneoff:false,isStable:false,consumption:0,baseEffect:[{kType:skillType.ATTACK,initNum:5,effNum:5,range:1,turns:0},{kType:skillType.DEFEND,initNum:5,effNum:5,range:0,turns:0}],descr:''},
    {cardType:cardType.DISTANCE_ATK,cardName:'手枪',isOneoff:false,isStable:false,consumption:1,baseEffect:[{kType:skillType.ATTACK,initNum:20,effNum:0,range:10,turns:0,descr:''}],descr:'载弹伤害:'},
    {cardType:cardType.DISTANCE_ATK,cardName:'手枪',isOneoff:false,isStable:false,consumption:1,baseEffect:[{kType:skillType.ATTACK,initNum:20,effNum:0,range:10,turns:0,descr:''}],descr:'载弹伤害:'},
    {cardType:cardType.DISTANCE_ATK,cardName:'手枪',isOneoff:false,isStable:false,consumption:1,baseEffect:[{kType:skillType.ATTACK,initNum:20,effNum:0,range:10,turns:0,descr:''}],descr:'载弹伤害:'},
    ...
    {cardType:cardType.EFFECT,cardName:'格挡',isOneoff:false,isStable:false,consumption:0,baseEffect:[{kType:skillType.DEFEND,initNum:5,effNum:5,range:0,turns:0,descr:'护甲:持续一回合'}],descr:''},
    {cardType:cardType.EFFECT,cardName:'格挡+',isOneoff:false,isStable:false,consumption:0,baseEffect:[{kType:skillType.DEFEND,initNum:10,effNum:10,range:0,turns:0,descr:'护甲:持续一回合'}],descr:''},
